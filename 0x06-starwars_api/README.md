...
## 0x06. Star Wars API -- Algorithm API JavaScript
...
- Mock Technical
[Interview](https://intranet.alxswe.com/rltoken/du6hlPQm6qi4A7eEursNhQ)
...
- You must use the [Star wars
API](https://intranet.alxswe.com/rltoken/gh_NaSUk9QlXHVoACFU-tg)
